...
//            this.precision = precision;
//            this.generateOperations = generateOperations;
//            decimalFormat = new DecimalFormat("#" + (precision > 0 ? "." + "#".repeat(precision) : ""));
//        }
//
//        @Override
//        public double getMinNumber() {
...
//                    getDiffNumber() * random.nextDouble() + getMinNumber()));
//        }
//
//        protected String numToStr(double number) {
...
//     * @param statement   текст задания
//     * @param answer ответ на задание
//     * @param precision эпсилон ответа
//     */
//    public AbstractMathTask(String statement, double answer, int precision) {
//        this.statement = statement;
//        this.answer = answer;
//        decimalFormat = new DecimalFormat("#" + (precision > 0 ? "." + "#".repeat(precision) : ""));
...
//    public Result validate(String answer) {
//        try {
//            if (Math.abs(this.answer - Double.parseDouble(answer)) < epsilon) {
//                return Result.OK;
//            } else {
//                return Result.WRONG;
//            }
